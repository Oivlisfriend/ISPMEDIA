...
const ModalPlaylist = observer(({ viewPlaylist }: PlaylistViewProps) => {
  return (
    <div className="w-96 p-6 absolute left-[35rem] top-[18%] z-20 bg-[#1C1C1C] text-white rounded-lg shadow-lg">
      <h2 className="text-xl font-semibold mb-4">Criar Playlist</h2>
      <form>
        <div className="mb-4">
          ...
          <input
            type="text"
            id="Playlist-name"
            onChange={viewPlaylist?.handleInputChange}
        ...
        <div className="mb-4">
          ...
          <select
            value={viewPlaylist?.payloadPlaylist.visibilidade}
            onChange={viewPlaylist?.handleTipoChange}
            id="privacy"
        ...
        <div className="flex justify-between gap-3">
          <button
            onClick={viewPlaylist?.createPlaylist}
            type="button"
          ...
          <button
            onClick={viewPlaylist?.toggleModal}
            type="button"
